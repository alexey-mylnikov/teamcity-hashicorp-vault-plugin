...
class VaultBuildFeature(dispatcher: EventDispatcher<AgentLifeCycleListener>,
    ...
    override fun buildStarted(runningBuild: AgentRunningBuild) {
        ...
        namespaces.forEach { namespace ->
            ...
            val backoffPeriod = parameters[getVaultParameterName(namespace, VaultConstants.BACKOFF_PERIOD_PROPERTY_SUFFIX)]?.toLongOrNull() ?: 0L
            val maxAttempts = parameters[getVaultParameterName(namespace, VaultConstants.MAX_ATTEMPTS_PERIOD_PROPERTY_SUFFIX)]?.toIntOrNull() ?: 1
